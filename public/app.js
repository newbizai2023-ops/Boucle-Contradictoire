...
function validateKeys(showErrors = false) {
  ...
  if ($('#webSearch').checked && !['valid','server'].includes(fireStatus)) errors.push('Une clé Firecrawl valide est obligatoire pour activer la vérification approfondie.');
